...
const iconData = [
  { Icon: Calendar, label: 'Events', color: 'text-primary', hover: 'hover-bg-primary' },
  { Icon: Music, label: 'Concerts', color: 'text-danger', hover: 'hover-bg-danger' },
  { Icon: Landmark, label: 'Venues', color: 'text-success', hover: 'hover-bg-success' },
  { Icon: Users, label: 'Communities', color: 'text-warning', hover: 'hover-bg-warning' },
];
      ...
      <section className="p-5 text-center bg-light animate__animated animate__fadeIn">
        ...
        <div className="container mb-4">
          <div className="row justify-content-center g-4">
            {iconData.map(({ Icon, label, color }, idx) => (
              <div
                key={label}
